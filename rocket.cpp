...
2. the player chooses one of the scenarios (launch_to_orbit_planet, landing_planet);
    ...
    - landing_moon: altitude_start: 150, altitude_goal: 0, speed_start: 0,speed_goal: 50  fuel: 200, planet_mass: 1;
    - landing_earth: altitude_start: 150, altitude_goal: 0, speed_start: 0,speed_goal: 50  fuel: 200, planet_mass: 6;
3. 
4.
5.
6.
